            ...
            <div class="flex justify-between items-center h-full">
                ...
                >
                    ...
                    <button
                        ...
                        "
                        @click="
                            this.$store.themeSettingsStore.sidebarCollasp = false
                        "
                    >
                        <Icon
                ...
                <div
                    v-if="
                        this.$store.themeSettingsStore.menuLayout ===
                        'horizontal'
                    "
...
export default {
    ...
    computed: {
        moduleName() {
            ...
            return this.$store.app.$state.currentModule;
        },
        headerButton() {
            return this.$store.app.$state.headerActions;
        },
    },
