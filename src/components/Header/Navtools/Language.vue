    ...
    <div>
        <Listbox v-model="selectLanguage">
            <div class="relative z-[22]">
                ...
                >
                    <span
                        class="inline-block md:h-6 md:w-6 w-5 h-5 rounded-full"
                        ><img
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span
                                        class="flex-1 lg:text-base text-sm capitalize"
                                    >
                                        {{ item.name }}</span
                                    >
                                </div>
...
import langImg2 from "@/assets/images/flags/vn.png";
...
export default defineComponent({
    ...
    created() {
        this.selectLanguage = this.months[0];
    },
    data() {
        return {
            months: [
                { name: "Vn", image: langImg2 },
    ...
    watch: {
        selectLanguage(newVal) {
            this.$langStore.setCurrentLang(newVal.name.toLocaleLowerCase());
        },
    },
});
</script>
